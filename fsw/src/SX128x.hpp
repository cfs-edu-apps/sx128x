...
/*!
	 ...
	 */
   //error: ISO C++ forbids zero-size array ‘RadioRegsInit’
   //cfs const RadioRegisters_t RadioRegsInit[0] = {};
const RadioRegisters_t RadioRegsInit[1] = {0,0}; //cfs
	...
	*/
   //cfs error: ISO C++ forbids compound-literals
	//cfs TickTime_t RX_TX_CONTINUOUS = (TickTime_t) {RADIO_TICK_SIZE_0015_US, 0xFFFF};
	//cfs TickTime_t RX_TX_SINGLE = (TickTime_t) {RADIO_TICK_SIZE_0015_US, 0};
   TickTime_t RX_TX_CONTINUOUS = {(RadioTickSizes_t)RADIO_TICK_SIZE_0015_US, (uint16_t)0xFFFF};
   TickTime_t RX_TX_SINGLE     = {(RadioTickSizes_t)RADIO_TICK_SIZE_0015_US, (uint16_t)0};
